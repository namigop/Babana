...
public class DeliveryDetails {
    [JsonProperty("courierId")] public string CourierId { get; set; }
    ...
    [JsonProperty("deliveryStartTime")] public string DeliveryStartTime { get; set; }

    [JsonProperty("deliveryEndTime")] public string DeliveryEndTime { get; set; }
    ...
    [JsonProperty("deliveryFee")] public DeliveryFee DeliveryFee { get; set; }

    [JsonProperty("deliveryFeeSku")] public string DeliveryFeeSku { get; set; }

    [JsonProperty("instruction")] public string Instruction { get; set; }

    [JsonProperty("deliveredAt")] public string DeliveredAt { get; set; }
...
public class Result {
    [JsonProperty("orderReference")] public string OrderReference { get; set; }

    [JsonProperty("shipments")] public List<Shipment> Shipments { get; set; }
}
...
public class Shipment {
    ...
    [JsonProperty("userDetails")] public UserDetails UserDetails { get; set; }

    [JsonProperty("deliveryDetails")] public DeliveryDetails DeliveryDetails { get; set; }

    [JsonProperty("shipmentItems")] public List<ShipmentItem> ShipmentItems { get; set; }
}

public class ShipmentItem {
    [JsonProperty("shipmentItemId")] public string ShipmentItemId { get; set; }

    [JsonProperty("shipmentCategory")] public string ShipmentCategory { get; set; }

    [JsonProperty("productCode")] public string ProductCode { get; set; }

    [JsonProperty("itemValue")] public string ItemValue { get; set; }
