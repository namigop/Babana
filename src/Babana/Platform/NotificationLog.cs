...
public class AdditionalIdentifiers
    ...
    public class Log
    {
        ...
        [JsonProperty("internal_log")]
        public InternalLog InternalLog { get; set; }
    ...
    public class RequestData
    {
        ...
        [JsonProperty("mock_auth")]
        public bool MockAuth { get; set; }
        ...
        [JsonProperty("sms_sender_number")]
    ...
    public class ServiceProviderResponse
    {
        ...
        [JsonProperty("provider_tried")]
        public object ProviderTried { get; set; }
    }
